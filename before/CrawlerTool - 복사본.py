...
class OpenCrawler:
    def __init__(self, search_keyword):
        ...
        # ----- 인스턴스 변수선언 ----
        self.xlwrite = None
        self.sorted_indices_by_name = None
        self.sorted_indices_by_count = None
        self.admin_ordinance_dict = None  # 조례 딕셔너리 None값 선언
        self.admin_ordinance_clause_dict = None  # 조례 세부조항 딕셔너리 None값 선언
    ...
    def get_numbers_page_to_find(self):
        ...
        sum_element_results_to_search = int(soup.select_one('#container > div > div > div.list-top > div.left > p > span').get_text().replace(',',''))
